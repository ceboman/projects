...
class ContactoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $contactos = $em->getRepository('GestionBundle:Contacto')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('GestionBundle\Form\ContactoType', $contacto);
    ...
    {
        $deleteForm = $this->createDeleteForm($contacto);
        $editForm = $this->createForm('GestionBundle\Form\ContactoType', $contacto);
