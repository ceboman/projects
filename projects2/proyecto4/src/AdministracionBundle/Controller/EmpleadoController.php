...
use AdministracionBundle\Entity\Empleado;
...
class EmpleadoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $empleados = $em->getRepository('AdministracionBundle:Empleado')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AdministracionBundle\Form\EmpleadoType', $empleado);
        $form->handleRequest($request);

        $usuarioCreacion = $this->getUser();
        $empleado->setUsuarioCreacion($usuarioCreacion);

        $usuarioActualizacion = $this->getUser();
        $empleado->setUsuarioActualizacion($usuarioActualizacion);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('empleado_show', array('idEmpleado' => $empleado->getIdempleado()));
        }
     ...
     *
     * @Route("/{idEmpleado}", name="empleado_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{idEmpleado}/edit", name="empleado_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Empleado $empleado)
    {
        $deleteForm = $this->createDeleteForm($empleado);
        $editForm = $this->createForm('AdministracionBundle\Form\EmpleadoType', $empleado);
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('empleado_edit', array('idEmpleado' => $empleado->getIdempleado()));
        }
     ...
     *
     * @Route("/{idEmpleado}", name="empleado_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Empleado $empleado)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('empleado_delete', array('idEmpleado' => $empleado->getIdempleado())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
