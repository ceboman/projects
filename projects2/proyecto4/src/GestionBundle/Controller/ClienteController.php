...
use GestionBundle\Entity\Cliente;
...
class ClienteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $clientes = $em->getRepository('GestionBundle:Cliente')->findAll();
    ...
    {
        $cliente = new Cliente();
        $form = $this->createForm('GestionBundle\Form\ClienteType', $cliente);
        ...
        $cliente->setUsuarioActualizacion($usuarioActualizacion);
    ...
    {
        $deleteForm = $this->createDeleteForm($cliente);
        $editForm = $this->createForm('GestionBundle\Form\ClienteType', $cliente);
